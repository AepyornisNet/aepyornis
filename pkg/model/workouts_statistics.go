...
FirstPoint      *DataPoint    `json:"firstPoint"`      // First GPS point in this item
LastPoint       *DataPoint    `json:"lastPoint"`       // Last GPS point in this item
...
func (bi *BreakdownItem) createNext(fp *DataPoint) BreakdownItem {
...
func (bi *BreakdownItem) canHave(count float64, unit string, fp *DataPoint) bool {
switch unit {
case "distance":
...
func (bi *BreakdownItem) applyRangeStats(stats DataRangeStats) {
...
if w.Data == nil || len(w.Data.Points) == 0 {
return nil
}
