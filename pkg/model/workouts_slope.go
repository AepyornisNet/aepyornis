...
Start    DataPoint     `gorm:"serializer:json" json:"start"`
EndIdx   int           `json:"end_idx"`
End      DataPoint     `gorm:"serializer:json" json:"end"`
...
currentSegmentPoints []*DataPoint
...
// CalculateSlopes processes a slice of DataPoints and returns a slice of Segments.
func (m *TrackData) CalculateSlopes() {
...
func SmoothSlopeGrades(points []DataPoint, windowMeters float64) {
for i := range points {
...
func DetectSignificantSegments(points []DataPoint, kind SlopeKind) []Segment {
...
detector.currentSegmentPoints = []*DataPoint{prevPoint, currentPoint}
}
...
detector.currentSegmentPoints = []*DataPoint{}
}
}
}
...
func (d *Detector) validateAndAppendSegment(segmentPoints []*DataPoint) {
