...
type RouteSegmentMatch struct {
	...
	first, last DataPoint // The first and last point of the route
	end         DataPoint // The last point of the workout
...
func (rs *RouteSegment) StartingPoints(points []DataPoint) []int {
	var r []int
