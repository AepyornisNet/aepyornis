...
@Component({
  selector: 'app-workout-power-records',
  imports: [DecimalPipe, TranslatePipe, FormatDistancePipe, FormatDurationPipe, FormatSpeedPipe],
  templateUrl: './workout-power-records.html',
  styleUrl: './workout-power-records.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WorkoutPowerRecordsComponent {
